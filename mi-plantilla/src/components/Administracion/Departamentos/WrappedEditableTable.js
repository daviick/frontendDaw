        ...
        <Table
          ...
          columns={[
            ...
            },
            {
              ...
              key: 'creado_por',
              ...this.getColumnSearchProps('creado_por'),
              editable: false,
              render: (text, record) => {
                if (record.isEditing) {
                  return <FormItem>
                    {getFieldDecorator('creado_por', {
                      rules: [
                        {
                          required: true,
                          message: 'Por favor, ingrese por quien fue creado'
                        }
                      ],
                      initialValue: record.creado_por
                    })(
                      <Input />
                    )}
                  </FormItem>
